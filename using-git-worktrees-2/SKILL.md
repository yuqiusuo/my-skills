...
description: Use when starting feature work that needs workspace isolation, before executing implementation plans, or when parallel branches must stay separate
---
