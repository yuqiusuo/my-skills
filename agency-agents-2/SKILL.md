...
The source repository is `msitarzewski/agency-agents`. These files are role instructions, not executable tools. Treat them as expert guidance layered on top of Claude Code's normal tool use and safety constraints.
